...
![功能扩展演示](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190524-103729@2x.png)

可以看到查询出web标签的三篇文章，重新输入网址：[http://127.0.0.1:8080?tag=http](http://127.0.0.1:8080?tag=http)http标签下的三篇文章也被查询出来了。

![http标签查询结果](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190524-104605@2x.png)

下面我们输入以下页码：[http://127.0.0.1:8080?page=3](http://127.0.0.1:8080?page=3)

![通过页码获取](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190524-104754@2x.png)
...
![文件上传效果](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190524-114125@2x.png)

点击提交文件按钮后，可以上传图片了。

![上传图片成功](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190524-114242@2x.png)

我们可以查询一下数据库：
![数据库验证](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190524-114318@2x.png)
...
#### 2.3.4 项目运行
我们上传几张图片后，刷新页面：
![图片查看](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190524-114301@2x.png)
...
![beego框架执行流程](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190527-103955@2x.png)
