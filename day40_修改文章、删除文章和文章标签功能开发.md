...
![项目运行](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190522-155033@2x.png)

我们就修改第一篇文章：
![修改文章](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190522-155245@2x.png)

提交修改效果：
![查看修改效果](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190522-155431@2x.png)

也可以查询数据库，也已经更新完毕：
![数据库修改](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190522-155627@2x.png)
...
![删除提示](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190522-161409@2x.png)
我们删除第一篇文章，点击删除按钮。然后弹出确认框，选择确定。就会删除第一篇文章。然后跳转到首页。
![刷新首页](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190522-161420@2x.png)
我们发现首页已经没有第一篇文章了，此时也可以查询一下数据库：
![数据库验证](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190522-161457@2x.png)
...
### 3.5 项目运行
重新启动项目后，在浏览器中点击标签按钮：
![项目运行](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190522-165548@2x.png)
