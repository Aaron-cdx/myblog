...
![项目创建](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190519-230051@2x.png)

然后通过goland打开该项目：
![项目目录](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190520-062806@2x.png)
...
![项目运行](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190520-063001@2x.png)

我们可以看到，项目已经运行了，并且监听在8080的端口上。接下来我们打开浏览器输入网址：[http://127.0.0.1:8080/](http://127.0.0.1:8080/)，然后可以看到欢迎界面：
![浏览器效果](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190520-063119@2x.png)
...
首先我们先在创建一个数据库：
![数据库创建](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190520-063304@2x.png)
...
![项目运行命令](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190520-065447@2x.png)

项目启动后，监听在8080端口上。

并且执行了InitMysql()方法，初始化数据库，我们打开数据库进行刷新，已经创建好了一张数据表user：

![数据库表](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190520-083914@2x.png)

打开浏览器，输入以下网址：[http://localhost:8080/register](http://localhost:8080/register) ,然后输入用户名和密码进行注册。

![注册接口调用](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190520-084747@2x.png)

![数据库表数据查看](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190520-084800@2x.png)
...
![用户登录](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190520-090352@2x.png)

![登录成功内容提示](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190520-090526@2x.png)

## 三 项目Session处理
### 3.1 Session使用场景介绍
我们希望用户登录后可以有写博客的功能，当然也允许用户退出：
![写博客功能](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190521-104344@2x.png)

如果用户没有登录，直接访问首页，只可以查看文章，标签，相册等，但是没有写博客的功能：
![无权限写文章](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190521-104814@2x.png)
...
#### 3.2.5 视图层开发
我们需要如下几个功能：
![导航栏](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190521-111948@2x.png)
...
浏览器如下：
![浏览器效果](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190521-113931@2x.png)

服务器端运行如下：
![后台程序日志](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190521-114207@2x.png)

点击退出按钮，后台程序执行效果：
![退户功能日志](../Golang-100-Days/Day38-41(beego框架开发博客系统)/img/WX20190521-135733@2x.png)
